...
from utils.load_configs import get_node_classification_args, ExperimentSetting
...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        args.save_model_name = f'node_classification_{args.model_name}_seed{args.seed}' \
            if args.comments == None else f'node_classification_{args.model_name}_seed{args.seed}_{args.comments}'
        ...
        for epoch in range(args.num_epochs):
            ...
            if (epoch + 1) % args.test_interval_epochs == 0:
                ...
                for metric_name in test_metrics.keys():
                    test_metrics_indicator.append((metric_name, test_metrics[metric_name], True))
                early_stop = early_stopping.step(test_metrics_indicator, model)
