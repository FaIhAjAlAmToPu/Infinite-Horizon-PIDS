...
class TimeEncoder(nn.Module):
    ...
    def __init__(self, time_dim: int, parameter_requires_grad: bool = True, same_timestamp_set: bool = False, pos_encoder_set: bool = False
                 , add_pos_encoding: bool = False, beta = 9):
        """
        Time encoder.
        ...
        self.w.weight = nn.Parameter((torch.from_numpy(1 / 10 ** np.linspace(0, beta, time_dim, dtype=np.float32))).reshape(time_dim, -1))
